...
X
apply(X, 1, mean) # cálculo de la media para las filas=1
apply(X, 2, median) # cálculo de la mediana para las columnas=2
...
setwd("C:/Users/bety-/Documents/CURSOS/DATA SCIENCE/FundamentosR/sesion2/ejercicio5")
